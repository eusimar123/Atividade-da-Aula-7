public class App {
    public static void main(String[] args) throws Exception {
        PessoaFisica eusimar = new PessoaFisica("Eusimar", "Queiroz", "Masculino", "Casado", "48705-000", "82187576515", 37);
        eusimar.setCep("48705-000");
        System.out.println(eusimar.getCep());
    }  
}
